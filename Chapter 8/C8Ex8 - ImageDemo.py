...
class ImageDemo:
    def __init__(self):
        ...
        usImage = PhotoImage(file="image/usIcon.png")
        ukImage = PhotoImage(file="image/ukIcon.png")
        crossImage = PhotoImage(file="image/x.png")
        circleImage = PhotoImage(file="image/o.png")
